...
Delete a cdrom drive to a virtual machine

=item interface

Delete a network interface to a virtual machine

=item disk

Delete a hard disk from a virtual machine
