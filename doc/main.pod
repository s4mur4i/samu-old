...
s{4}VI_USERNAME=
s{4}VI_PASSWORD=
s{4}VI_SERVER=10.21.0.1
s{4}VI_URL=https://10.21.0.1/sdk
s{4}VI_PORTNUMBER=443
s{4}VI_PROTOCOL=HTTPS
s{4}VI_SERVICEPATH=/sdk/webService
...
s{4}PERL_LWP_SSL_VERIFY_HOSTNAME=0
...
s{4}dpkg -i deb/<package>.deb
s{4}apt-get install -f
...
s{4}TEST=1 ./TEST_PERL_MODULES.pl
...
s{4}Krisztian Banhidy <s4mur4i@balabit.hu>
