...
samu.pl -- Support Automatisation Management Util
...
The ticket attached to the envirnoment
...
Whcih machines runtime information should we dump (dumps raw hash)
...
List networks interfaces attached to a vm

=item cdrom

List cdroms attached to a vm
...
samu.pl vm list disk [options] [function]
...
=head2 VM_change_disk_function

=head3 SYNOPSIS

samu.pl vm change disk [options]
...
Name of requeted parent. Defaults to vm folder
...
=head2 VM_delete_cdrom_function

=head3 SYNOPSIS

samu.pl vm delete cdrom [options]
...
=head2 VM_delete_interface_function

=head3 SYNOPSIS

samu.pl vm delete interface [options]
...
Id of interface to delete

=back

=head2 VM_delete_disk_function

=head3 SYNOPSIS

samu.pl vm delete disk [options]
...
=head2 VM_delete_vm_function

=head3 SYNOPSIS

samu.pl vm delete vm [options]
...
=head2 VM_delete_folder_function

=head3 SYNOPSIS

samu.pl vm delete folder [options]
...
=head2 VM_delete_resourcepool_function

=head3 SYNOPSIS

samu.pl vm delete resourcepool [options]
...
=head2 NETWORK_list_function

=head3 SYNOPSIS

samu.pl network list [options]
