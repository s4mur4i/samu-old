...
=head3 SYSNOPSIS
    ...
    jew.pl admin [functions] [options]
...
=head3 SYNOPSIS
    ...
    jew.pl admin templates [options]
...
=item * There is alot of anal sex happening at my desk
