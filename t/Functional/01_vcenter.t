...
file_filter_ok( $visdkrc, "VI_USERNAME", \&filter_username,
    "visdkrc contains username" );
file_filter_ok( $visdkrc, "VI_PASSWORD", \&filter_password,
    "visdkrc contains password" );
file_filter_ok( $visdkrc, "VI_SERVER", \&filter_server,
    "visdkrc contains server" );
file_filter_ok( $visdkrc, "VI_PORTNUMBER", \&filter_port,
    "visdkrc contains port number" );
file_filter_ok( $visdkrc, "VI_URL", \&filter_url, "visdkrc contains url" );
file_filter_ok( $visdkrc, "VI_PROTOCOL", \&filter_protocol,
    "visdkrc contains protocol" );
file_filter_ok( $visdkrc, "VI_SERVICEPATH", \&filter_service,
    "visdkrc contains servicepath" );
