...
output_like( sub { &Log::debug2("Test") }, qr/^$/ ,qr/^Log_${level}.t\s\[DEBUG2\]:\sTest;$/ , "Debug 2 output ok on level $level" );
output_like( sub { &Log::debug1("Test") }, qr/^$/ ,qr/^Log_${level}.t\s\[DEBUG1\]:\sTest;$/ , "Debug 1 output ok on level $level" );
output_like( sub { &Log::debug("Test") }, qr/^$/ ,qr/^Log_${level}.t\s\[DEBUG\]:\sTest;$/ , "Debug output ok on level $level" );
output_like( sub { &Log::info("Test") }, qr/^$/ ,qr/^Log_${level}.t\s\[INFO\]:\sTest;$/ , "Info output ok on level $level" );
