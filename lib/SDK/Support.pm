...
BEGIN {
        ...
        our @EXPORT_OK = qw( &test %template_hash %agents_hash &linked_clone_template_folder_path &generate_network_setup_for_clone &win_VirtualMachineCloneSpec &lin_VirtualMachineCloneSpec &oth_VirtualMachineCloneSpec);
}
